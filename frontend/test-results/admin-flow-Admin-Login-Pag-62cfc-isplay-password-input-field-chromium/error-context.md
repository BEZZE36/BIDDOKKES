...
- Name: admin-flow.spec.js >> Admin Login Page >> should display password input field
- Location: tests\admin-flow.spec.js:34:3
...
Locator: locator('#admin-password')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#admin-password')
