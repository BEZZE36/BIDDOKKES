...
- Name: admin-flow.spec.js >> Admin Login Page >> should display email input field
- Location: tests\admin-flow.spec.js:28:3
...
Call log:
  ...
  - waiting for locator('#admin-email')
